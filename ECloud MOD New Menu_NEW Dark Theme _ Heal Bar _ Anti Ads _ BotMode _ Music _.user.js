// ==UserScript==
// @name ECloud MOD New Menu|NEW Dark Theme | Heal Bar | Anti Ads | BotMode | Music |
// @version    1.2
// @description Menu![❚Macro = Z-Tank Gear + Shadow Wings Space Bar-Blood Wings + Bull Helmet C-Medic Gear + Angel Wings M- Velocity Esc-Modify❚] [❚Featured Hacker❚] [❚Musket + Katana = *,* Katana & *.* Musket❚] [❚Instakill Key = R❚] [❚Bow+Rep.+Musk. Key = K ❚] [❚AutoHeal 5 times faster than MooJaX❚] [❚Very hard to get clown❚] [❚InstaKill Spike = On/Off❚] [❚KeyCodes= Y- BotMode;V - Pike;F - Pit;N - Windmill❚] [❚Circles= L-Spike O-Pit P-Windmill J-Turret❚] [❚★Premium MAP★❚] [❚!AutoChat!❚] [❚!AutoSpawn!❚]
// @icon         https://vignette.wikia.nocookie.net/moom/images/8/85/Hat_45.png/revision/latest/top-crop/width/360/height/450?cb=20171206232219
// @match        *://moomoo.io/*
...
$("followText").remove();
document.getElementById('loadingText').innerHTML = 'if u wanna sub, hit the link: top left!';
document.getElementById('gameName').innerHTML = 'ECloud MOD';
document.getElementById("leaderboard").append('ECloud MOD');;
...
if (fh == false) {
    ...
    ´
		<div class="spanLink" id="featuredYoutube"><a target="_blank" class="ytLink" href="https://www.youtube.com/channel/UCEzOrBiSuJKDNSYSwIiVTWg/"><i class="material-icons" style="vertical-align: top;"></i> ECloud on IO</a></div>
	</div>
Featured Hacker:`) // ECloud on IO
} else {
}
}, 10000);
...
<div id="simpleModal" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h2 style="font-size: 17px;">ECloud & Macro Settings</h2>
        </div>
